...
# Placeholder link set for stage 0. Real targets (tag pages, author
# pages, search) land in later patches -- see docs/migration.md,
# sequencing steps 5-6 -- and these hrefs get filled in then.
_NAV_LINKS = (
    ("Tags", "/tags"),
    ("Authors", "/authors"),
    ("Search", "/search"),
